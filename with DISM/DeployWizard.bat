...
:: Author:Joshua Chang
:: Date:Sep 26 2014
:: Updated by : Joshua Chang 08/28/2015
color E
chdir /D %~dp0
...
echo 3. Deploy WIMBoot Operation (PE 5.1 only)
echo 4. Install pure OS
echo 5. Install Driver Packages (.inf)
echo 6. Install Cabinet (.cab) or Windows Update Stand-alone Installer (.msu)
echo 7. Enable Net3.5 feature
echo 8. Exit
echo.
echo.
...
if "%mychoice%"=="3" goto WIMBootOperation
if "%mychoice%"=="4" goto OS
if "%mychoice%"=="5" goto Driver
if "%mychoice%"=="6" goto cab&msu
if "%mychoice%"=="7" goto Net3.5
if "%mychoice%"=="8" goto EXIT
if "%mychoice%"=="0" goto Wizard
if "%mychoice%" GEQ 9 goto Wizard
