...
:: Author:Joshua Chang
:: Date:Nov 19 2015
:: Updated by : Joshua Chang 03/25/2016
cls
...
dism /get-wiminfo /wimfile:%CHK_DISK%:\%Windows_image%.wim
...
:ApplyImage
::dism /Apply-Image /ImageFile:%CHK_DISK%:\%Windows_image%.wim /Index:%index_number% /ApplyDir:c:\
imagex /apply %CHK_DISK%:\%Windows_image%.wim %index_number% w:\ /verify
If %errorlevel% NEQ 0 (
	color 4C
	echo.
