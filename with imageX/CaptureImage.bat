...
:: Author:Joshua Chang
:: Date:Nov 19 2015
:: Updated by : Joshua Chang 11/24/2015
cls
...
echo ===========================
::Dism /Capture-Image /ImageFile:%CHK_DISK%:\%Windows_image%.wim /CaptureDir:c:\ /Name:"Windows" /Compress:max
imagex /capture c:\ %CHK_DISK%:\%Windows_image%.wim "%Windows_image%" /check /compress maximum /verify
If %errorlevel% NEQ 0 (
	color 4C
	echo.
